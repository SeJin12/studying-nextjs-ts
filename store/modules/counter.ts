// 액션 타입을 선언한다.
// 뒤에 as const 를 붙여줌으로써 나중에 액션 객체를 만들게 action.type 값을 추론하는 과정에서
// action.type이 string 으로 추론되지 않고 'counter/INCREASE' 와 값이 실제 문자열 값으로 추론 되도록 해줍니다
...
/*
    ...
    액션에서는 우리가 방금 만든 CounterAction 타입으로 설정
*/
